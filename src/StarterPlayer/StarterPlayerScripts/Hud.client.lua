...
local lobbyEvent = eventsFolder and eventsFolder:FindFirstChild("LobbyState")
...
local lobbyWait = Instance.new("TextLabel")
 lobbyWait.Name = "LobbyWait"
 lobbyWait.Size = UDim2.new(0, 260, 0, 40)
 lobbyWait.Position = UDim2.new(0.5, -130, 0, 130)
 lobbyWait.BackgroundTransparency = 0.35
 lobbyWait.BackgroundColor3 = Color3.fromRGB(30, 30, 60)
 lobbyWait.TextColor3 = Color3.fromRGB(230, 230, 230)
 lobbyWait.Font = Enum.Font.GothamBold
 lobbyWait.TextScaled = true
 lobbyWait.Text = ""
 lobbyWait.Visible = false
 lobbyWait.Parent = gui
...
roundEvent.OnClientEvent:Connect(function(payload)
	...
	elseif payload.status == "waiting" then
		...
		-- Ocultar elementos de ronda para lobby
